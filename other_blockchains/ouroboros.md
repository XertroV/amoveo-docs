...
I have written a general paper about why [PoS is not possible](proof_of_stake.md)
...
[Here people attempt to show that the attack in this paper wont work](the_defence_of_pos.md)
...
For example, we cannot even agree on which security model is securing bitcoin [bitcoin.md](bitcoin.md)
